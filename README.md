...
Diario di gruppo per le cime dell'Appennino sopra i 2000 m (270 vette).
...
| Sezione | Descrizione |
|---|---|
| **Mappa** | Tutte le 270 cime su mappa topografica (Esri World Topo Map), con marker colorati in base al numero di alpinisti che le hanno salite (0–5). Filtri per alpinista e gruppo montuoso. |
